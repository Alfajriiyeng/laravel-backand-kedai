    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Hi, Fajri!</h2>
                <p class="section-lead">
                    my instagram: fajriiyeng.
                </p>
                    ...
                    <div class="col-12 col-md-12 col-lg-5">
                        <div class="card profile-widget">
                            ...
                            <div class="profile-widget-description">
                                <div class="profile-widget-name">Fajri <div
                                        class="text-muted d-inline font-weight-normal">
                                        <div class="slash"></div> proflayer gaming
                                    </div>
                                </div>
                                Yanes is a proflayer gaming name in <b>Indonesia</b>,
                                He is someone who is generous and kind, also saves diligently and many say is also handsome
                                <b>'pak ape'</b>.
                            </div>
                            <div class="card-footer text-center">
                                <div class="font-weight-bold mb-2">Follow Yanes On your sosmed</div>
                                <a href="#"
